...
class OTPCenter(models.Model):
    ...
    def active(cls, phone):
        ...
        return next((otp for otp in queryset if (timezone.now() - otp.created_at) < cls.expre_duration), None)
...
class CustomUserManager(BaseUserManager):
    def create(self, phone, userType, *args, **kwargs):
...
class CustomUser(BaseConfig, AbstractUser):
    ...
    picture = models.ImageField(upload_to=USER_MEDIA, null=True)
